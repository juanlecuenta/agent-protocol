...
@Serdeable
@JsonPropertyOrder({
    Step.JSON_PROPERTY_INPUT,
    Step.JSON_PROPERTY_ADDITIONAL_INPUT,
    Step.JSON_PROPERTY_TASK_ID,
    Step.JSON_PROPERTY_STEP_ID,
    Step.JSON_PROPERTY_NAME,
    Step.JSON_PROPERTY_STATUS,
    Step.JSON_PROPERTY_OUTPUT,
    Step.JSON_PROPERTY_ADDITIONAL_OUTPUT,
    Step.JSON_PROPERTY_ARTIFACTS,
    Step.JSON_PROPERTY_IS_LAST
})
...
public class Step {
    ...
    public Step(String taskId, String stepId, StatusEnum status, List<Artifact> artifacts, Boolean isLast) {
        this.taskId = taskId;
        this.stepId = stepId;
        this.status = status;
     ...
     * @return The same instance of Step for chaining.
     */
    public Step input(String input) {
        this.input = input;
        return this;
    }
     ...
     * @return The same instance of Step for chaining.
     */
    public Step additionalInput(Object additionalInput) {
        this.additionalInput = additionalInput;
        return this;
    }
     ...
     * @return The same instance of Step for chaining.
     */
    public Step taskId(String taskId) {
        this.taskId = taskId;
        return this;
    }
     ...
     * @return The same instance of Step for chaining.
     */
    public Step output(String output) {
        this.output = output;
        return this;
    }
     ...
     * @return The same instance of Step for chaining.
     */
    public Step additionalOutput(Object additionalOutput) {
        this.additionalOutput = additionalOutput;
        return this;
    }
     ...
     * @return The same instance of Step for chaining.
     */
    public Step artifacts(List<Artifact> artifacts) {
        this.artifacts = artifacts;
        return this;
    }
     ...
     * @return The same instance of Step for chaining.
     */
    public Step addArtifactsItem(Artifact artifactsItem) {
     ...
     * @return The same instance of Step for chaining.
     */
    public Step isLast(Boolean isLast) {
        this.isLast = isLast;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        Step step = (Step) o;
        return Objects.equals(this.input, step.input) &&
            Objects.equals(this.additionalInput, step.additionalInput) &&
            Objects.equals(this.taskId, step.taskId) &&
            Objects.equals(this.stepId, step.stepId) &&
            Objects.equals(this.name, step.name) &&
            Objects.equals(this.status, step.status) &&
            Objects.equals(this.output, step.output) &&
            Objects.equals(this.additionalOutput, step.additionalOutput) &&
            Objects.equals(this.artifacts, step.artifacts) &&
            Objects.equals(this.isLast, step.isLast);
    }

    @Override
    public int hashCode() {
        return Objects.hash(input, additionalInput, taskId, stepId, name, status, output, additionalOutput, artifacts, isLast);
    }
